 ...
 * @param {number} value
 */
Data.prototype.writeUInt16LE = function (value) {
	this._alloc(2)
	this._buffer.writeUInt16LE(value, this._length)
	this._length += 2
}
 ...
 * @param {number} value
 */
Data.prototype.writeUInt32LE = function (value) {
	this._alloc(4)
 ...
 * @param {number} value
 */
Data.prototype.writeFloat = function (value) {
	this._alloc(4)
 ...
 * @param {number} value
 */
Data.prototype.writeFloatLE = function (value) {
	this._alloc(4)
 ...
 * @param {number} value
 */
Data.prototype.writeUIntX = function (value, size) {
    switch(size) {
        case 4:
